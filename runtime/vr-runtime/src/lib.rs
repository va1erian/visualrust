//! Packaged app runtime: hosts a compiled Dyon program in a xui window.
//!
//! [`RuntimeApp`] is the bridge between xui's retained message loop and a
...
//! xui types so it can be exercised headlessly.
//!
